namespace API.Controllers.OrderItems.v1
{
    ...
    public class OrderItemsController : BaseController<OrderItemEntity>
    {
        ...
        [ProducesResponseType(StatusCodes.Status408RequestTimeout)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<OrderItemPutResponse>> DeleteOrderItemAsync(string orderCode, [FromQuery] string productCode, CancellationToken cancellationToken = default)
        {

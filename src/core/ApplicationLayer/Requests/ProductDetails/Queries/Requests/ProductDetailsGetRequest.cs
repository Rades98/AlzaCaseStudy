...
namespace ApplicationLayer.Requests.ProductDetails.Queries.Requests
{
	...
	/// </returns>
	public class ProductDetailsGetRequest : IRequest<IList<ProductDetailGetResponse>>, ICacheableQuery
	{
		...
		public class Handler : IRequestHandler<ProductDetailsGetRequest, IList<ProductDetailGetResponse>>
		{
			...
			public async Task<IList<ProductDetailGetResponse>> Handle(ProductDetailsGetRequest request, CancellationToken cancellationToken)
			{

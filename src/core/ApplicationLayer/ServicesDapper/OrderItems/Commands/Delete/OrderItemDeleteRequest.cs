namespace ApplicationLayer.ServicesDapper.OrderItems.Commands.Delete
{
	...
	public class OrderItemDeleteRequest : IRequest<OrderItemDeleteResponse>
	{
		...
		public class Handler : IRequestHandler<OrderItemDeleteRequest, OrderItemDeleteResponse>
		{
			...
			{
				return new { @OrderCode = request.OrderCode, @ProductCode = request.ProductCode, @UserId = request.UserId };
			}
		}
	}
}

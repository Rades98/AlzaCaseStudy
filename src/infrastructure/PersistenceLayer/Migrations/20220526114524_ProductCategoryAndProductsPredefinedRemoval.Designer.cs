...
namespace PersistenceLayer.Migrations
{
    ...
    [Migration("20220526114524_ProductCategoryAndProductsPredefinedRemoval")]
    partial class ProductCategoryAndProductsPredefinedRemoval
    {
            ...
            modelBuilder.Entity("DomainLayer.Entities.Users.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Admin",
                            PasswordHash = new byte[] { 167, 1, 57, 72, 244, 223, 151, 83, 113, 161, 87, 21, 77, 92, 238, 13, 99, 251, 160, 26, 14, 159, 231, 46, 232, 213, 245, 169, 186, 146, 68, 131, 127, 244, 88, 150, 136, 237, 9, 53, 125, 172, 218, 28, 119, 53, 203, 105, 153, 178, 104, 235, 194, 182, 195, 33, 232, 94, 3, 193, 129, 33, 101, 61 },
                            PasswordSalt = new byte[] { 82, 207, 235, 114, 110, 208, 18, 198, 47, 219, 136, 72, 168, 42, 220, 145, 172, 114, 209, 8, 208, 102, 73, 76, 72, 127, 154, 145, 141, 3, 87, 95, 134, 9, 7, 7, 12, 120, 122, 27, 90, 161, 192, 14, 184, 128, 3, 49, 116, 156, 0, 110, 35, 126, 133, 210, 203, 166, 181, 172, 13, 88, 254, 14, 224, 50, 184, 102, 11, 219, 9, 46, 116, 117, 204, 161, 20, 56, 15, 177, 114, 47, 214, 107, 175, 44, 172, 98, 109, 71, 164, 168, 114, 132, 104, 182, 117, 57, 19, 184, 89, 241, 13, 163, 178, 196, 96, 36, 49, 5, 235, 33, 133, 197, 177, 65, 247, 225, 119, 137, 161, 31, 114, 61, 16, 127, 82, 76 },
                            Surname = "Admin",
                            UserName = "Admin"
                        });
                });

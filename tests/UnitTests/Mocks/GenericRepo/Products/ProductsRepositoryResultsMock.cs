    ...
    public static class ProductsRepositoryResultsMock
    {
        ...
        private static List<ProductDetailEntity> GetResponses()
        {
            return new() {
                ...
                //Special GET cases
                new() { Name = "test item", Created = _created, Price = 0, Id = ProductsRepositoryRequestsMock.ProductGetRequest.Id, ImgUri = new Uri("http://www.pagination.xx/pag"), Description = "Test data" },

                //Special Update cases
                new() { Name = "test item", Created = _created, Price = 0, Id = ProductsRepositoryRequestsMock.ProductUpdateRequestUptoDate.Id, ImgUri = new Uri("http://www.pagination.xx/pag"), Description = ProductsRepositoryRequestsMock.ProductUpdateRequestUptoDate.Description },
                new() { Name = "test item", Created = _created, Price = 0, Id = ProductsRepositoryRequestsMock.ProductUpdateRequest.Id, ImgUri = new Uri("http://www.pagination.xx/pag"), Description = "Test data" }
